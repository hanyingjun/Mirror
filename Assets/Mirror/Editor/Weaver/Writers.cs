...
namespace Mirror.Weaver
{
    ...
    public static class Writers
    {
        ...
        static MethodDefinition GenerateArraySegmentWriteFunc(TypeReference variable, int recursionCount)
        {
            ...
            ILProcessor worker = writerFunc.Body.GetILProcessor();
            MethodReference countGetterRef = WeaverTypes.Import(typeof(System.ArraySegment<>), nameof(System.ArraySegment<object>.Count));
            ...
            worker.Append(worker.Create(OpCodes.Ldarg_0));
            worker.Append(worker.Create(OpCodes.Ldarga_S, (byte)1));
            MethodReference arrayGetterRef = WeaverTypes.Import(typeof(System.ArraySegment<>), nameof(System.ArraySegment<object>.Array));
            worker.Append(worker.Create(OpCodes.Call, arrayGetterRef.MakeHostInstanceGeneric(genericInstance)));
            worker.Append(worker.Create(OpCodes.Ldloc_1));
            worker.Append(worker.Create(OpCodes.Ldarga_S, (byte)1));
            MethodReference offsetGetterRef = WeaverTypes.Import(typeof(System.ArraySegment<>), nameof(System.ArraySegment<object>.Offset));
